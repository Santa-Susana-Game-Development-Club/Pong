...
import com.sshsgd.pong.entities.Paddle.Side;
...
public class PlayState extends GameState {
    ...
    @Override
    protected void init() {
        myViewport = new MyViewport();
        ball = new Ball(25, 25, BounceMode.TOP_BOTTOM);
        playerPaddle = new PlayerPaddle(25, 100, Side.LEFT);
        aiPaddle = new AIPaddle(25, 100, Side.RIGHT);
        resetTime = 0;
        rightScore = 0;
        leftScore = 0;
    ...
    private void drawScore(SpriteBatch sb) {
        ...
        float leftX = (MyConstants.WORLD_WIDTH * .25f) - (leftWidth * .5f);
        ...
        float rightX = (MyConstants.WORLD_WIDTH * .75f) - (rightWidth * .5f);
